...
const config = Object.freeze({
  ...
  preferences: Object.freeze({ ...(raw.preferences || {}) }),
  ai: Object.freeze({ ...(raw.ai || {}) }),
  openaiKey: process.env.OPENAI_API_KEY,
  nwEmail: process.env.NW_EMAIL || '',
  nwPassword: process.env.NW_PASSWORD || '',
  server: Object.freeze({
    sessionTtl: raw.server?.sessionTtl || 1800000,
